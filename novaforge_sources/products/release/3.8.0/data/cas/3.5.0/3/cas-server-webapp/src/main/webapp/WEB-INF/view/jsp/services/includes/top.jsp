...
<meta name="version"
	content="<%=org.jasig.cas.CasVersion.getVersion()%>" />
<link rel="icon" href="<c:url value="../favicon.ico" />"
	type="image/x-icon" />
<link rel="stylesheet" href="<c:url value="/css/services/cas.css" />"
...
@media screen {
	...
	table#headerTable th,table#scrollTable td {
		padding: 0 5px;
		border: 0;
	}
...
<body id="${pageTitle}-body">
	...
	<div id="nav-main">
		<ul>
			<li><a id="addServiceView" href="add.html"><span><spring:message
							code="addServiceView" /></span></a></li>
			<li><a id="manageServiceView" href="manage.html"><span><spring:message
							code="manageServiceView" /></span></a></li>
			<li><a id="viewStatisticsView" href="viewStatistics.html"><span><spring:message
							code="viewStatisticsView" /></span></a></li>
		</ul>
	</div>
	<!-- CONTENT -->
	<div id="content">
