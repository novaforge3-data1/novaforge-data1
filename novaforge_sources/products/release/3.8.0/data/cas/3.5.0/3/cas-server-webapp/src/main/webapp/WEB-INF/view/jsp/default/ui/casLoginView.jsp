...
<script type="text/javascript">
	 function doAutoLogin() {
	 	document.getElementById('autoTitle').style.display = "block";
	 	document.getElementById('fm1').style.display = "none";
	  	document.forms[0].username.value = '<%= request.getParameter("login") %>';
	  	document.forms[0].password.value = '<%= request.getParameter("pwd") %>';		
		document.forms[0].submit();
	 }
	 function doLogin() {
	 	document.getElementById('autoTitle').style.display = "none";
...
<div class="box fl-panel" id="login">
	<img src="/cas/images/logos/novaforge.png"
		alt="NovaForge Authentification" id="logoNF" />
	<h2 id="autoTitle" style="display:none">
		<spring:message code="screen.welcome.auto" />
	</h2>
	<form:form method="post" id="fm1" cssClass="fm-v clearfix"
		commandName="${commandName}" htmlEscape="true" style="display:none">
		...
		<div class="row btn-row">
			<input type="hidden" name="lt" value="${loginTicket}" /> <input
				...
				class="btn-submit" name="autosubmit" accesskey="l" value="Login"
