...
public class GetRoles extends AbstractAlfrescoWebScript
{
  ...
  protected void internalTraitement() throws Exception
  {
    ...
    final Set<String> roles = permissionService.getSettablePermissions(repositoryHelper.getCompanyHome());
