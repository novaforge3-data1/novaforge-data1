 ...
 */
package net.bull.alfresco.framework.test;
 ...
 *
 */
public class CronSample implements Job
{
	...
	{
		this.jobCtx = jobCtx;
		log.trace("execute()-> Debut");
		doInternalJob();
		log.trace("execute()->Fin");
	}

	/**
	 * A rendre abstract.
	 */
	protected void doInternalJob()
	{
		log.trace("un exemple de cron");
	}
