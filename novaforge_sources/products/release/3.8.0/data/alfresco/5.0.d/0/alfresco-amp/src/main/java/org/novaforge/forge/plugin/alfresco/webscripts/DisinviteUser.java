...
public class DisinviteUser extends AbstractAlfrescoWebScript
{
   ...
   /**
    * Disassociate a user to a project
    * 
    * @return
    * @throws Exception
    */
   private void disinviteUser() throws Exception
   {
      // Initializing services
      ...
      if (!resultSet.getNodeRefs().isEmpty())
      {
         ...
         // Delete the permission to the project
         permissionService.deletePermission(projectRef, userName, role);
      }
      else
      {
