...
/**
 * Fournit les informations sur un objet liste
 * Doit etre utiliser sur la classe qui va etre ajouter a une liste.
 * 
 * @author Rouviere_x
 * @version 1.0
 */
...
@Documented
public @interface MetaDataListe 
{
	 ...
	 * 
	 */
	String description() default "INFO LISTE";
