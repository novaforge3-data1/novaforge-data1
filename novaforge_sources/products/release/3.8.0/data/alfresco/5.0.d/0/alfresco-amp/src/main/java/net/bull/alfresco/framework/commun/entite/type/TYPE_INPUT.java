...
/**
 * Les differents types d'inputs geres dans les formulaires.
 * 
 * @author Rouviere_x
 *
 */
public enum TYPE_INPUT 
{
	...
	NUMERIC,	//Saisie numerique uniquement
	
	DATE,	//Saisie au format date uniquement
	
	CHECKBOX,	//Case e cocher
	...
	LIST,	//Choix sur liste
	
	RADIO	//Liste de boutons radio
}
