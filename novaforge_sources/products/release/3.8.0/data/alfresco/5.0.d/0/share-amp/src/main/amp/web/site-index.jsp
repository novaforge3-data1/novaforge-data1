...
<%
   ...
   else
   {
      ...
      {
	   // no site dashboard page found! create initial dashboard for this user...
	   Map<String, String> tokens = new HashMap<String, String>();
	   tokens.put("siteid", siteName);
	   FrameworkUtil.getServiceRegistry().getPresetsManager().constructPreset("site-dashboard", tokens);
      }
