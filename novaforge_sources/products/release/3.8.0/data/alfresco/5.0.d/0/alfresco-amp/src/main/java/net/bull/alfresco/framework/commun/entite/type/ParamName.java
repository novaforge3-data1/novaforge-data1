...
/**
 * Fournit un type pour les noms de parametres.<br/>
 * Permet de faire des enumerations de ce type :<br>
 * <code>
 * public enum MyParam implements ParamName {NOM, PRENOM...}
 * </code>
 * 
 * @author Rouviere_x
 *
...
public interface ParamName
{
	...
	/**
	 * Methode pour convertir un string en ParamName
	 * @param nom
	 * @return
	 */
	//public ParamName convert(String nom);
}
