...
/**
 * Interface pour definir les listes Astre
 * 
 * @author Rouviere_x
 * 
 */
public interface Liste<E extends DematItem> extends List<E>
{

	/**
	 * Fournit la meta info sur la liste
	 * @return
	 */
	public InfoListe getInfo();
	
	/**
	 * Retourne les element sous forme de String
	 * 
	 * @return : String
	 */
	...
	/**
	 * Retourne l'element de la liste
	 * 	
	 */
