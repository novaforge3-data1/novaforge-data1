...
public interface Validateur<E>
{
	 ...
	 * @param err
	 */
	public ValidationResultat validate(E val);
	
	/**
	 * Indique si le validateur peut valider ce type de classe
	 * @param type
	 * @return
	 */
	public boolean supports(Class<E> type);
}
